...
for episode in range(max_episode):
    ...
    if episode == 0:
        ...
        random_index = random.choice(range(int(0.5 * len(os.listdir("trained_sp/fictitious_0/ap"))),
                                           len(os.listdir("trained_sp/fictitious_0/ap")) + 1))
        agent_ap.load("trained_sp/fictitious_0/ap/PPO_train_episode_{}.pth".format(random_index))
    ...
    while True:
        ...
        if chicken.is_done():
            ...
            agent_a.update()
            agent_a.save("trained_sp/fictitious_0/a/PPO_train_episode_" + "{}.pth".format(episode + 1))
            agent_a.save("trained_sp/fictitious_0/ap/PPO_train_episode_" + "{}.pth".format(episode + 1))
